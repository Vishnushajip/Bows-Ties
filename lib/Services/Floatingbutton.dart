...
class WhatsAppChatFAB extends ConsumerWidget {
  const WhatsAppChatFAB({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    const whatsappGreen = Color.fromARGB(255, 17, 149, 65);
    return Theme(
      ...
      child: FloatingActionButton(
        ...
        onPressed: () async {
          _showChatDialog(context, ref);
        },
        backgroundColor: Colors.white,
        elevation: 0,
        child: Image.network(
          "https://media.tenor.com/rZPzTbfYtC4AAAAM/whats-app.gif",
          width: 40,
          height: 40,
          fit: BoxFit.contain,
  ...
  void _showChatDialog(BuildContext context, WidgetRef ref) {
